<template>
  <el-dropdown trigger="click">
    ...
    <template #dropdown>
      <el-dropdown-menu>
        <el-tabs style="width: 300px" v-model="tabName" stretch>
        ...
        <div class="dropdown-wrapper" v-if="tabName === '通知'">
          <div class="notice-container" @click="handleClickItem(notice)" v-for="(notice, index) in notices" :key="index"
            ...
            <div class="notice-text">
              ...
              <div class="notice-time">{{ notice.time }}
              </div>
            </div>
          </div>
        </div>
        <div class="dropdown-wrapper" v-else-if="tabName === '消息'">
          <div class="message-container" v-for="(message, index) in messages" :key="index"
            :class="message.read ? 'read' : ''" @click="handleClickItem(message)">
        ...
        <div class="dropdown-wrapper" v-else>
          <div class="todo-container" v-for="(todo, index) in todos" :key="index" :class="todo.read ? 'read' : ''"
        ...
        <el-button-group style="inline-size: 100%">
          <el-button type="text" style="inline-size: 50%" @click="handleClear">清空{{ tabName }}</el-button>
          <el-button type="text" style="inline-size: 50%" @click="handleMore">查看更多</el-button>
        </el-button-group>
      </el-dropdown-menu>
    </template>
  </el-dropdown>
